...
function! fly_lint#validate() abort
  echo s:validate()
endfunction

function! fly_lint#enable_auto_validate() abort
  augroup fly_lint
    autocmd!
...
function! fly_lint#disable_auto_validate() abort
  augroup fly_lint
    autocmd!
  augroup END
endfunction

function! fly_lint#format() abort
...
function! fly_lint#force_format() abort
  call s:force_format()
  edit!
endfunction
